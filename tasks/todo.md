...
- [ ] **2. Local database, schema and security.** Supabase init, Drizzle schema, migrations. A seed script that generates fake data and refuses to run against anything but the local database.
